		...
		<div class="flex justify-between items-center h-16">
			...
			<div class="hidden md:flex md:space-x-8">
				{#each navItems as item}
					<a
						href={item.href}
						class="flex items-center space-x-2 px-3 py-2 text-sm font-medium transition-colors {$page.url?.pathname === item.href
			...
			<div class="px-2 pt-2 pb-3 space-y-1">
				{#each navItems as item}
					<a
						...
						class="flex items-center space-x-3 px-3 py-2 text-base font-medium rounded-md transition-colors {$page.url?.pathname === item.href
